...
description: Record Claude Code sessions with asciinema. TRIGGERS - record session, asciinema record, capture terminal, record claude, demo recording. Generates ready-to-copy commands with dynamic workspace-based filenames.
