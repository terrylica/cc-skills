...
| `stop-ty-project-check.ts`   | Project-wide ty type check on exit (only if .py files were edited, --python-version 3.14)                               |
...
### Pushover hard limits (official API, SSoT — verified 2026-05-29)
