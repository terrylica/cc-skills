...
NSDictionary *buildStarterProfiles(void) {
    return @{
        ...
        @"Night Owl": @{
            ...
            @"ShadowStyle": @"subtle",
            @"BorderStyle": @"hairline",
            @"CanvasColorMode": @"solar-atmospheric",
            @"Density": @"comfortable",
            @"ShowFlags": @NO,
            @"ShowUTCReference": @NO,
            @"ShowSkyState": @YES,
...
NSArray<NSString *> *profileManagedKeys(void) {
    return @[
        ...
        @"BorderStyle",                // 2026-06-11: hairline segment border
        @"CanvasColorMode",            // 2026-06-11: solar canvas (compact modes)
