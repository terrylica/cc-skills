...
> [!TIP]
> **Command Format**: Plugin commands display as `/itp:go`, `/itp:setup` in autocomplete. See [Slash Command Naming Convention](../../README.md#slash-command-naming-convention) for details on the `plugin:command` format.
