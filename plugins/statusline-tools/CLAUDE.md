...
| &lt;lvl&gt; / thinking:on·off / fast | Inference-mode badges from `.effort.level`, `.thinking.enabled`, `.fast_mode`. Effort renders bare (e.g. `· xhigh` — the `effort:` label was dropped 2026-06-11 per operator preference)                                                                                                                                                                                                                                                                                                                                               |
