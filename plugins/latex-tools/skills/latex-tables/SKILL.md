...
- [Table Patterns](/skills/latex/tables/references/table-patterns.md) - 5 common table patterns with examples
- [Column Specification](/skills/latex/tables/references/column-spec.md) - Alignment options and width control
- [Lines and Borders](/skills/latex/tables/references/lines-borders.md) - All lines, selective lines, thick lines
- [Troubleshooting](/skills/latex/tables/references/troubleshooting.md) - Table too wide, text not wrapping, alignment issues
- [Migration](/skills/latex/tables/references/migration.md) - Migrating from tabular and tabularx
