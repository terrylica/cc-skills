...
- [Installation](/skills/latex/setup/references/installation.md) - Full MacTeX vs lightweight options, Skim installation
- [Verification](/skills/latex/setup/references/verification.md) - Check installation, verify PATH, test compilation
- [Package Management](/skills/latex/setup/references/package-management.md) - Check, install, search for packages with tlmgr
- [Skim Configuration](/skills/latex/setup/references/skim-configuration.md) - Enable SyncTeX, configure preferences for editor integration
- [Troubleshooting](/skills/latex/setup/references/troubleshooting.md) - PATH issues, tlmgr problems, permissions
