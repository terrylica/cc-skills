...
AUTO_NAV_JS_BODY = """\
/* ----------------------------------------------------------------------
 * auto-nav.js — drag-to-resize for the navigation rail.
 *
 * Generated by build-nav.py. Pages without JS still get a fully usable
 * rail at the default width; this script only adds drag-to-resize.
 * Persists user-chosen width to localStorage under "autoNavWidth_v1".
 * ---------------------------------------------------------------------- */
(function () {
  "use strict";
  var STORE_KEY = "autoNavWidth_v1";
  var MIN_W = 240;
  var MAX_W = 960;
  var DEFAULT_W = 320;
  ...
  function loadWidth() {
    try {
      ...
      if (!isNaN(v) && v >= MIN_W && v <= MAX_W) applyWidth(v);
