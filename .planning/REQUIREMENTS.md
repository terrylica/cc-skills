...
- [ ] **BUILD-02**: Package.swift includes swift-telegram-sdk v4.5.0 and sherpa-onnx static lib linker settings
- [ ] **BUILD-03**: Bridging header correctly imports sherpa-onnx C API and ONNX Runtime C API
